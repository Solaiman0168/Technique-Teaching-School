...
<?php $table_heading = "আমাদের সম্পর্কে - ৫";?>
<?php include 'include/sidebar.php';?>
<?php include 'include/body-top.php';?>
   
<?php
        $tbl_name="home_about_us5";       //your table name
        $targetpage = "home_about_us5.php";   //your file name  (the name of this file)
    ...
    {
             $home_about_us5_id = $_POST['home_about_us5_id'];
         ...
         $sql = "UPDATE $tbl_name SET `bn_title` = '$bn_title' ,`bn_short_details` ='$bn_short_details',`bn_speech` ='$bn_short_details',`en_title` = '$en_title' ,`en_short_details` ='$en_short_details',`en_speech` ='$en_short_details',`is_updated` = 1, `updated_by` = $user_no ,`updated_on` = '$CURR_TIME' WHERE `home_about_us5_id` = 1";
...
?>
     ...
     <?php
        $sql = "SELECT * FROM $tbl_name WHERE `home_about_us5_id` = 1 ";
    ...
    ?>
     ...
     <div class="form-group " <?php if($mgs=='')echo "style='display:none;'" ?>>
            ...
            <div>
                <input type="hidden" name="home_about_us5_id" value="<?=$result['home_about_us5_id']?>" />
            </div>
        </div>
