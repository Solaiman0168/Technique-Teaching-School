...
<?php $table_heading = "ভর্তির নিয়ামাবলি";?>
<?php include 'include/sidebar.php';?>
<?php include 'include/body-top.php';?>
   
<?php
        $tbl_name="home_admission_rule";       //your table name
        $targetpage = "home_admission_rule.php";   //your file name  (the name of this file)
    ...
    {
             $home_admission_rule_id = $_POST['home_admission_rule_id'];
            ...
            $sql = "UPDATE $tbl_name SET  `bn_details` = '$bn_details' ,`en_details` = '$en_details' ,`is_updated` = 1, `updated_by` = $user_no ,`updated_on` = '$CURR_TIME' WHERE home_admission_rule_id = 1";
...
?>
     ...
     <?php
        $sql = "SELECT * FROM $tbl_name WHERE `home_admission_rule_id` = 1 ";
    ...
    ?>
     ...
     <div class="form-group " <?php if($mgs=='')echo "style='display:none;'" ?>>
            ...
            <div>
                <input type="hidden" name="home_admission_rule_id" value="<?=$result['home_admission_rule_id']?>" />
            </div>
        </div>
