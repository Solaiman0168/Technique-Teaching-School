...
<?php $table_heading = "উপন্যাস";?>
<?php include 'include/sidebar.php';?>
<?php include 'include/body-top.php';?>
  
<?php
        $tbl_name="novel";       //your table name
        $targetpage = "novel.php";   //your file name  (the name of this file)
    ...
    if(isset($_POST['submit']))
    {
            ...
            $en_details = mysqli_real_escape_string($con,trim($_POST['en_details']));
                 ...
                 $SQL = "SELECT * FROM $tbl_name WHERE `is_deleted` = 0 AND `bn_name` ='$bn_name' AND `en_name` = '$en_name' AND `bn_student_name` = '$bn_student_name' AND `en_student_name` = '$en_student_name'AND `bn_class` = '$bn_class'AND `en_class` = '$en_class'AND `bn_date` = '$bn_date'AND `en_date` = '$en_date' AND `bn_details` = '$bn_details'AND `en_details` ='$en_details' ";
                   ...
                   $sql = "INSERT INTO $tbl_name SET `bn_name` ='$bn_name' , `en_name` = '$en_name' , `bn_student_name` = '$bn_student_name' , `en_student_name` = '$en_student_name', `bn_class` = '$bn_class', `en_class` = '$en_class',`bn_date` = '$bn_date', `en_date` = '$en_date' , `bn_details` = '$bn_details', `en_details` ='$en_details' , `bn_short_details` = '$bn_details', `en_short_details` ='$en_details' , `image_url` = '$image_url', `created_by`='$user_no', `created_on`='$CURR_TIME'";
        ...
        $SQL = "SELECT * FROM $tbl_name WHERE `is_deleted` = 0 AND `bn_name` ='$bn_name' AND `en_name` = '$en_name' AND `bn_student_name` = '$bn_student_name' AND `en_student_name` = '$en_student_name'AND `bn_class` = '$bn_class'AND `en_class` = '$en_class'AND `bn_date` = '$bn_date'AND `en_date` = '$en_date' AND `bn_details` = '$bn_details'AND `en_details` ='$en_details' AND `novel_id` != '$novel_id'";
            ...
            if($COUNT < 1): 
                if ($_FILES["image_url"]["error"] > 0) {
                  ...
                  $sql = "UPDATE $tbl_name SET `bn_name` ='$bn_name' , `en_name` = '$en_name' , `bn_student_name` = '$bn_student_name' , `en_student_name` = '$en_student_name', `bn_class` = '$bn_class', `en_class` = '$en_class',`bn_date` = '$bn_date', `en_date` = '$en_date' , `bn_details` = '$bn_details', `en_details` ='$en_details' ,`bn_short_details` = '$bn_details', `en_short_details` ='$en_details' , `image_url` = '$image_url' , `is_updated` = 1, `updated_by` = '$user_no' ,`updated_on` = '$CURR_TIME' WHERE `novel_id` = '$novel_id'";
                $result = mysqli_query($con,$sql);
                if($result)
                {
...
?>
    ...
    <?php $i=$page*$limit-$limit+1; while($row = mysqli_fetch_array($result)):?>
        <tr>
            ...
            <td>
                <a onclick="return confirm('Are you Sure Want to Edit?');" href="<?=$targetpage.'?edit='.$row['novel_id']?>" class="btn btn-primary"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a>
                <a onclick="return confirm('Are you Sure Want to Delete?');" href="<?=$targetpage.'?delete='.$row['novel_id']?>" class="btn btn-danger"><i class="fa fa-trash-o" aria-hidden="true"></i></a>
            </td>
        </tr>
    <?php endwhile;?>
    </table>
