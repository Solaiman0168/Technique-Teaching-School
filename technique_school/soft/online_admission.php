...
<?php $table_heading = "এডমিশন";?>
<?php include 'include/sidebar.php';?>
<?php include 'include/body-top.php';?>

  
<?php
        $tbl_name="online_admission";       //your table name
        $targetpage = "online_admission.php";   //your file name  (the name of this file)
    ...
    {
        $ID = $_GET['delete'];
        $sql = "UPDATE $tbl_name SET `is_deleted` = 1 ,`deleted_by` = '$user_no', `deleted_on` = '$CURR_TIME' WHERE online_admission_id = $ID";
    ...
    <div style="overflow: auto">
        ...
        <table   class="table table-bordered table-hover table-responsive table-condensed table-striped dataTable col-xs-12 col-sm-12 col-md-6 col-lg-6 ">
            <tr>
                ...
                <th><center>Name</center></th>
                 <th><center>Applied Class</center></th>
        ...
        <?php $i=$page*$limit-$limit+1; while($row = mysqli_fetch_array($result)):?>
            <tr>
                ...
                <td> 
                   <center> <a onclick="return confirm('Are you Sure Want to Delete?');" href="<?=$targetpage.'?delete='.$row['online_admission_id']?>" class="btn btn-danger"><i class="fa fa-trash-o" aria-hidden="true"></i></a></center>
                </td>
            </tr>
        <?php endwhile;?>
        </table>
